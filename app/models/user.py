...
class User(Base):
    ...
    addresses: Mapped[list['Address']]= relationship(back_populates="users", cascade="all, delete-orphan")
    orders: Mapped[list['Order']] = relationship(back_populates='users')
    reviews: Mapped[list['Review']] = relationship(back_populates='users')
    wishlist: Mapped[list['Wishlist']] = relationship(back_populates='users', cascade="all, delete-orphan")
    cart: Mapped['Cart'] = relationship(back_populates='users', uselist=False, cascade="all, delete-orphan")
